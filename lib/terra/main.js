...
app.get("/withdraw", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const tx = yield wallet.wallet.createAndSignTx({ msgs: [msg], memo: memo, feeDenoms: [denom] });
...
app.get("/placeOrder", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const quantityS = req.query['quantity'];
        var spread = req.query['spread'] || undefined;
        var feeDenom = req.query['fee'] || undefined;
        ...
        const { assets } = yield LCD.wasm.contractQuery(pool.addr, { pool: {} });
        var beliefPrice = "";
        var denom = "";
        if (side == "Buy") {
        ...
        const tx = yield wallet.wallet.createAndSignTx(request);
        const result = yield LCD.tx.broadcast(tx);
        res.json(result);
    }
    catch (e) {
