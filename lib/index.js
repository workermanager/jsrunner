...
function ReadJSONMeta(filename) {
    let rawdata = (0, fs_1.readFileSync)(filename).toString();
    var result = {};
    var preComment = "";
    var preProperty = "";
    jsonc.visit(rawdata, {
        onComment: (offset, length) => preComment = rawdata.substring(offset, offset + length),
        onObjectProperty: (property) => preProperty = property,
...
exports.ReadJSONMeta = ReadJSONMeta;
//setup conf
exports.Config = {};
...
function LogPrintState(...args) {
    return __awaiter(this, void 0, void 0, function* () {
        console.log(...args);
        return yield LogState(...args);
    });
}
exports.LogPrintState = LogPrintState;
